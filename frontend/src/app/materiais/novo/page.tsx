...
export default function MateriaisNovoPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([t, u]) => {
        ...
        setForm((f) => ({
          ...f,
          materialTypeId: f.materialTypeId || t[0]?.id || '',
          unitId: f.unitId || u[0]?.id || '',
        }));
      })
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-slate-800 mt-2">Novo material</h1>
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            placeholder="Ex.: iniciais geradas ao digitar o nome"
          />
          <p className="text-xs text-slate-500 mt-1">
            Sugestão automática pelas iniciais de cada palavra; edite o campo se quiser outro código.
          </p>
        </div>
        <div>
