...
export default function RamosAtividadeNovoPage() {
  ...
  useEffect(() => {
    ...
    else if (!canEdit('config_ramos')) router.replace('/configuracoes/ramos-atividade');
  }, [router]);
  ...
  async function submit(e: FormEvent) {
    ...
    try {
      ...
      router.push('/configuracoes/ramos-atividade');
    } catch (ex) {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-slate-800 mt-2">Novo ramo de atividade</h1>
